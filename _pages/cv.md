...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <div style="width: 80px; height: 60px; margin-right: 20px; flex-shrink: 0; display: flex; align-items: center; justify-content: center;">
    <img src="/images/lilly-logo.png" alt="Eli Lilly Logo" style="max-width: 80px; max-height: 60px; object-fit: contain;">
  </div>
  <div>
    <strong>Eli Lilly and Company</strong><br>
    Academic Contractor (Co-op)<br>
